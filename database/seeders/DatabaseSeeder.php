...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //DOCTOR
        DB::table('menus')->insert(['idmenu'=>7,'nommenu'=>'Usuarios','logo'=>'fa fa-users']);
        DB::table('menus')->insert(['idmenu'=>8,'nommenu'=>'Control Prenatal','logo'=>'fa fa-edit']); 
        DB::table('menus')->insert(['idmenu'=>9,'nommenu'=>'Carnet Perinatal','logo'=>'fa fa-calendar-check']);

        //ENFERMERA
        DB::table('menus')->insert(['idmenu'=>10,'nommenu'=>'Usuarios','logo'=>'fa fa-users']); 
        DB::table('menus')->insert(['idmenu'=>11,'nommenu'=>'Antecedentes','logo'=>'fa fa-list']);
        DB::table('menus')->insert(['idmenu'=>12,'nommenu'=>'Gestacion Actual','logo'=>'fa fa-female']);
        DB::table('menus')->insert(['idmenu'=>13,'nommenu'=>'Control Prenatal','logo'=>'fa fa-edit']); 
        DB::table('menus')->insert(['idmenu'=>14,'nommenu'=>'Carnet Perinatal','logo'=>'fa fa-calendar-check']);
        DB::table('menus')->insert(['idmenu'=>15,'nommenu'=>'Reportes','logo'=>'fa fa-flag']);

        //PACIENTE
        DB::table('menus')->insert(['idmenu'=>16,'nommenu'=>'Carnet Perinatal','logo'=>'fa fa-calendar-check']);
        ...
        //DOCTOR
        DB::table('rolmenus')->insert(['idrol'=>2,'idmenu'=>7]);
        DB::table('rolmenus')->insert(['idrol'=>2,'idmenu'=>8]);
        DB::table('rolmenus')->insert(['idrol'=>2,'idmenu'=>9]);

        //ENFERMERA
        DB::table('rolmenus')->insert(['idrol'=>3,'idmenu'=>10]);
        DB::table('rolmenus')->insert(['idrol'=>3,'idmenu'=>11]);
        DB::table('rolmenus')->insert(['idrol'=>3,'idmenu'=>12]);
        DB::table('rolmenus')->insert(['idrol'=>3,'idmenu'=>13]);
        DB::table('rolmenus')->insert(['idrol'=>3,'idmenu'=>14]);
        DB::table('rolmenus')->insert(['idrol'=>3,'idmenu'=>15]);

        //PACIENTE
        DB::table('rolmenus')->insert(['idrol'=>4,'idmenu'=>16]);
        ...
        DB::table('menu_vistas')->insert(['idmenu'=>5,'idv'=>8]); 
        ...
        //DOCTOR
        DB::table('menu_vistas')->insert(['idmenu'=>7,'idv'=>1]);
        DB::table('menu_vistas')->insert(['idmenu'=>8,'idv'=>7]);
        DB::table('menu_vistas')->insert(['idmenu'=>9,'idv'=>9]);

        //ENFERMERA
        DB::table('menu_vistas')->insert(['idmenu'=>10,'idv'=>2]);
        DB::table('menu_vistas')->insert(['idmenu'=>11,'idv'=>4]);
        DB::table('menu_vistas')->insert(['idmenu'=>12,'idv'=>5]);
        DB::table('menu_vistas')->insert(['idmenu'=>13,'idv'=>6]); 
        ...
        //PACIENTE
        DB::table('menu_vistas')->insert(['idmenu'=>16,'idv'=>8]);
        ...
        $user->genero = 'M'; 
        $user->fechanacimiento = '1989-01-29'; 
        $user->email = 'doctor@hotmail.com';
        $user->password = bcrypt('doctor');
        $user->save();

        $user = new \App\Models\User(); 
        $user->name = 'Samira Condo'; 
        $user->idrol = 3; 
        $user->iddepartamento = 1; 
        $user->idprovincia = 19; 
        $user->ci = 1234567; 
        $user->genero = 'F'; 
        $user->fechanacimiento = '1989-01-29'; 
        $user->email = 'enfermera@hotmail.com';
        $user->password = bcrypt('enfermera');
        $user->save();

        $user = new \App\Models\User(); 
        $user->name = 'Karen Poma'; 
        $user->idrol = 4; 
        $user->iddepartamento = 1; 
        $user->idprovincia = 19; 
        $user->ci = 1234567; 
