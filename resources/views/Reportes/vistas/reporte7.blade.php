...
<footer>
 <img src="{{ public_path('assets/img/footer.png') }}" width="100%" height="100%">  
    ...
    <div class="body_wrapper">
        ...
        <h1 style="color: #0c49a5;text-align: center;">Reporte de pacientes que van a trabajo de parto</h1>
       ...
       <tbody>
           ...
           @foreach ($data as $paciente)
            @if(!is_null($paciente->getmayor))
                @if($paciente->getmayor->edadgest >= 37)
                <tr>
