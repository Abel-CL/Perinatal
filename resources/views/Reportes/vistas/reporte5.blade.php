...
<footer>
 <img src="{{ public_path('assets/img/footer.png') }}" width="100%" height="100%">  
    ...
    <div class="body_wrapper">
        ...
        <h1 style="color: #0c49a5;text-align: center;">Reporte de metodo con mas fracaso</h1>
       ...
       <thead>
           <tr>
           <th>Nº</th> 
           <th class="align-middle" style="text-align: center;">Metodo</th>
       ...
       <tbody>
           ...
           <tr>
               <td style="width:25px;text-align: center;">{{$i}}</td>  
                @switch($paciente->fracasometodo)
                    @case(1)
                    <td class="align-middle" style="text-align: center;">No usaba</td>
                        @break 
                    @case(2)
                    <td class="align-middle" style="text-align: center;">Barrera</td>
                        @break
                    @case(3)
                    <td class="align-middle" style="text-align: center;">Hormonal</td>
                        @break
                    @case(4)
                    <td class="align-middle" style="text-align: center;">Emergencia</td>
                        @break
                    @case(5)
                    <td class="align-middle" style="text-align: center;">Tradicional</td>
                        @break
