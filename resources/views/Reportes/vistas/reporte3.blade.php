...
<html lang="en">
<head>
    <title>Embarazos planeados</title>
</head>
<style>@page {
    margin: 0cm 0cm;
}
...
<footer>
 <img src="{{ public_path('assets/img/footer.png') }}" width="100%" height="100%">  
    ...
    <div class="body_wrapper">
        ...
        <h1 style="color: #0c49a5;text-align: center;">Reporte de Pacientes que planearon su embarazo</h1> 
        <table class="table">
       <thead>
           <tr>
           <th>Nº</th>  
       ...
       <tbody>
           ...
           @if ($paciente->embarazoplaneado==1)
           <tr>
   ...
   <h1 style="color: #0c49a5;text-align: center;">Reporte de Pacientes que no planearon su embarazo</h1> 
        <table class="table">
       <thead>
           <tr>
           <th>Nº</th>  
       ...
       <tbody>
           ...
           @endphp
           @foreach ($data as $paciente)
           @if ($paciente->embarazoplaneado==0)
           <tr>
               <td style="width:25px;text-align: center;">{{$i}}</td>  
                <td class="align-middle" style="text-align: center;">{{ $paciente->name}}</td>
                <td class="align-middle" style="text-align: center;">{{ $paciente->cip }}</td>
