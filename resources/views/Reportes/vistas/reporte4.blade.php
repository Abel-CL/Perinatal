...
<footer>
 <img src="{{ public_path('assets/img/footer.png') }}" width="100%" height="100%">  
    ...
    <div class="body_wrapper">
        ...
        <h1 style="color: #0c49a5;text-align: center;">Reporte de madres gestantes con riesgo menores de 15</h1> 
        <table class="table">
       <thead>
           <tr>
           <th>Nº</th>  
           <th class="align-middle" style="text-align: center;">Nombre </th>
           <th class="align-middle" style="text-align: center;">Edad</th>
       ...
       <tbody>
           ...
           <tr>
               <td style="width:25px;text-align: center;">{{$i}}</td>  
                ...
                <td class="align-middle" style="text-align: center;">{{ $paciente->edad}}</td>
   ...
   <h1 style="color: #0c49a5;text-align: center;">Reporte de madres gestantes con riesgo mayores de 35</h1> 
        <table class="table">
       <thead>
           <tr>
           <th>Nº</th>  
